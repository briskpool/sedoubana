...
function locationInfo() {
    ...
    this.confCity = function(id) {
     //   console.log(id);
     //   console.log('started');
        var url = rootUrl+'?type=confCity&countryId2='+ jQuery('#countryId2 option:selected').attr('countryid2') +'&stateId=' + jQuery('#stateId2 option:selected').attr('stateid2') + '&cityId2=' + id;
        var method = "post";
        var data = {};
    ...
    this.getCities = function(id) {
        ...
        var url = rootUrl+'?type=getCities&countryId2='+ jQuery('#countryId2 option:selected').attr('countryid2') +'&stateId2=' + id + addParams + addClasses;
        var method = "post";
        var data = {};
    ...
    this.getStates = function(id) {
        ...
        var url = rootUrl+'?type=getStates&countryId2=' + id + addParams  + addClasses;
        var method = "post";
        var data = {};
