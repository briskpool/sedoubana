...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 font-weight: normal; text-decoration: none" target="_blank" title="We have received reset password request from your account.">
                                  <img align="none" alt="We have received reset password request from your account." height="32" src="https://sedoubana.com/sedu-front/assets/images/logo.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">We have received reset password request from your account. Please click on "Reset Password" button below. If you didn't do this then simply ignore this email. Thanks
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                      ...
                                      ?>
                                        <a class="mcnButton " href="<?php echo base_url().'login/new-password/'.$email_hash.'?user='.$user;?>" style="mso-line-height-rule: exactly;
