        ...
        <div class="container ">
            <div class="row">
                ...
                <div class="form-group col-md-2  d-none d-lg-block d-md-block ">
                    <a href="<?php echo base_url(); ?>requests" class="float-right  px-0"><i class="mr-1 far fa-envelope"></i>My Requests</a>
                </div>
            ...
            <div class="row px-2 justify-content-center">
                <div class="col-md-8 py-2  request-form ftco-animate fadeInUp ftco-animated">
                    ...
                    <div class="row  ">
                        <form action="<?php echo base_url(); ?>support/request" method="post" enctype="multipart/form-data" class="needs-validation col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="subject" type="text" id="validationServer01" placeholder="Subject" required>
