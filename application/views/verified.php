...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 background-color: #efefef; height: 100%; margin: 0; padding: 0; margin-bottom: 30px; width: 100%">
  <center>
 ...
 100%; background-color: #efefef; height: 100%; margin: 0; padding: 0; width:
 100%" width="100%">
      <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #efefef;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                <a href="https://sedoubana.com/" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #2a2a2a;
 font-weight: normal; text-decoration: none" target="_blank" title="We have received reset password request from your account.">
                                  <img align="none" alt="We have received reset password request from your account." height="32" src="https://sedoubana.com/assets/images/logo.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 text-decoration: none; height: auto; width: 224px; height: 54px; margin: 0px;" width="107" />
                                </a>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                <a class="" href="https://www.sedoubana.com" style="mso-line-height-rule:
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #f57153; font-weight: normal; text-decoration: none" target="_blank" title="">
                                    <img align="center" alt="Forgot your password?" class="mcnImage" src="<?php echo base_url(); ?>assets/images/verification.png" style="-ms-interpolation-mode: bicubic; border: 0; width:100px; height: 100px; outline: none;
 ...
 padding: 0'><span style="text-transform:uppercase">Verified</span></h2>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Your account has been verified.
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                        ...
                                        <a class="mcnButton " href='<?php echo base_url(); ?>login' style="mso-line-height-rule: exactly;
 ...
 #FFFFFF; text-transform:uppercase;" target="_blank" title="">Login Here</a>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 12px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">If you have any question or facing problems with sedoubana.com, feel free to contact us:
                            <a href="mailto:contact@sedoubana.com" target="_top">contact@sedoubana.com</a>
                            <br></br>
                          </td>
