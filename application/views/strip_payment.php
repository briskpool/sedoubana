                            ...
                            <div class="card mb-5 mb-lg-0">
                                <div class="card-body">
                                    ...
                                    <form action="<?php print site_url(); ?>stripe-checkout" method="post" class="frmStripePayment">
                                        <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="pk_test_wvwEOhfkVFE6ujFnFB8C9pno00xmoaVWMc" data-name="<?= $setting->sub_plan ?>" data-description="$<?= $setting->sub_price ?>/per year" data-panel-label="Pay Now" data-label="Subscribe" data-email="<?= $email ?>" data-locale="auto" , data-currency="<?= $setting->sub_currency ?>">
                                        </script>
                                    </form>
                                </div>
                            </div>
