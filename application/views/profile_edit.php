                                ...
                                <div class="request-form p-1 p-md-3">
                                    <div class="container px-0">
                                        <div class="col-md-12 ftco-animate fadeInUp ftco-animated">
                                            ...
                                            <form action="<?php echo base_url(); ?>profile/update" enctype="multipart/form-data" method="post" class="ftco-animate request-form" name="reg_form">
                                                ...
                                                <div class="row ">
                                                    ...
                                                    <div class="form-group col-md-6 col-12 form-group">
                                                        ...
                                                        <input type="email" name="email" id="p_email" value="<?php echo ($email) ? $email : '' ?>" class="form-control" placeholder="Email" disabled>
                                                    </div>
                                                ...
                                                <div class="row py-2">
                                                    <div class="form-group col-md-4 col-12 mt-3">
                                                        <input class="nav-link btn btn-primary" name="send" type="submit" value="Save">
                                                    </div>
