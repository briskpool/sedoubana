...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 font-weight: normal; text-decoration: none" target="_blank" title="Sedoubana">
                                  <img align="none" alt="Sedoubana" height="32" src="https://sedoubana.com/assets/images/logo.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Please verify your account by clicking on the link below.
                                <br></br>
                              </td>
                            </tr>
                          </tbody>
 ...
 padding-right:48px; padding-bottom:24px; padding-left:48px;" valign="middle">
                                      <?php 
                                        $email_hash=md5($this->config->item('salt').$email);
                                        $data=array('email'=>$email);
                                        $this->session->set_userdata('send_email',$data);
                                      ?>
                                        <a class="mcnButton " href='<?php echo base_url()."register/activation/".$response."/".$code."/".$user;?>' style="mso-line-height-rule: exactly;
 ...
 <a href="mailto:info@sedoubana.com" target="_top">info@sedoubana.com</a>
                                <br></br>
                              </td>
