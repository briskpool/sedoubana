                        ...
                        ?>
                            <div class="row pt-2 pb-2 border-top row-hover">
                                ...
                                <div class="col-md-3 col-12 py-0">
                                    <a class="text-info font-extra-small py-0  float-right" data-toggle="collapse" href="#read-more-<?= $row->id ?>" role="button" aria-expanded="false" aria-controls="read-more-<?= $row->id ?>">Read More</a>
                                </div>
                                <div class="col-md-2"></div>
                                <div class=" col-8 font-extra-small  collapse" id="read-more-<?= $row->id ?>">
