      ...
      <div class="container">
        <div class="row px-2 justify-content-center">
            ...
            <div class="col-md-8  pl-0">
              <p class="breadcrumbs mb-0"><span class="mr-2"><a href="<?php echo base_url();?>support">Contact Support <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2">My Requests</span> </p>
            </div>
               ...
               <div class="col-md-8 py-2 d-none d-lg-block d-md-block  request-form ftco-animate fadeInUp ftco-animated"> 
                ...
                <div class="row pt-2 pb-2 border-top row-hover">
                    <div class="col-md-1   col-4">
                    <p  class=" mb-0 font-extra-small">123456</p > 
                    </div>
                    <div class="col-md-5 col-4">
                     <a href="<?php echo base_url();?>requests/thread" class=" mb-0 text-info  font-extra-small"> Withdraw payment option are disabled.
                    </a > 
                    </div>
               ...
               <div class="col-md-12 mt-2 py-2 d-block d-lg-none d-md-none request-form ftco-animate fadeInUp ftco-animated">
                ...
                <div class="row pb-2">
                    ...
                    <div class="col-12 pr-0">
                      <a href="<?php echo base_url();?>requests/thread" class="mb-0 text-info font-extra-small ">Withdraw payment option are disabled.</a>
