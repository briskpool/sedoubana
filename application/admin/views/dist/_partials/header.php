...
}elseif ($this->uri->segment(1) != "login" && $this->uri->segment(1) != "forgot-password"&& $this->uri->segment(2) != "auth_register" && $this->uri->segment(1) != "reset-password" && $this->uri->segment(2) != "errors_503" && $this->uri->segment(2) != "errors_403" && $this->uri->segment(2) != "errors_404" && $this->uri->segment(2) != "errors_500" && $this->uri->segment(2) != "utilities_contact" && $this->uri->segment(2) != "utilities_subscribe") {
