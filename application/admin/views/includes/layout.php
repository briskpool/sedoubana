      ...
      <nav class="navbar navbar-expand-sm main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="https://png.pngitem.com/pimgs/s/506-5067022_sweet-shap-profile-placeholder-hd-png-download.png" class="rounded-circle mr-1">
            <div class="d-sm-none d-lg-inline-block"><?=($user->id)?$user->fname.' '.$user->lname:''?></div>      <!--  <?php echo $image; ?> --></a>
